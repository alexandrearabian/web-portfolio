...
export default function HomePage({ repos }: { repos: Repo[] }) {
  ...
  return (
    <div className="bg-background relative mt-16 min-h-screen overflow-x-hidden">
      <div className="pointer-events-none fixed inset-0 bg-[linear-gradient(to_right,#8841fc2e_2px,transparent_2px),linear-gradient(to_bottom,#8841fc2e_1px,transparent_1px)] bg-[size:24px_24px]"></div>
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center space-y-8 text-center sm:space-y-12">
          ...
          >
            <h1 className="text-foreground bg-gradient-to-r from-purple-600 to-blue-500 bg-clip-text text-5xl font-bold tracking-tight sm:text-6xl md:text-7xl">
              <span className="block sm:inline">{t.hero.greeting}</span>{" "}
              <span className="relative bg-gradient-to-r from-purple-600 to-blue-500 bg-clip-text text-transparent">
          ...
          >
            ...
            >
              <Link
                href="#contact"
                className="block rounded-full bg-purple-600 px-6 py-3 text-center text-base font-semibold text-white transition-colors hover:bg-purple-500 sm:px-8 sm:py-4"
            ...
            >
              <Link
                href="#projects"
                className="block rounded-full border border-purple-600 px-6 py-3 text-center text-base font-semibold transition-colors hover:bg-purple-600/10 sm:px-8 sm:py-4"
            ...
            >
              ...
              <div className="flex flex-wrap gap-2 sm:gap-3">
                {[
                  ...
                  <motion.span
                    key={skill}
                    className="rounded-full bg-purple-600/10 px-3 py-1.5 text-xs text-purple-600 sm:px-4 sm:py-2 sm:text-sm"
                    initial={{ opacity: 0, scale: 0.8 }}
              ...
              >
                <Card className="group bg-background relative flex h-full flex-col overflow-hidden rounded-lg border shadow-lg transition-colors hover:border-purple-500">
                  ...
                  <CardContent className="flex-1 pb-3">
                    {repo.language && (
                      <span className="inline-block rounded-full bg-purple-600/10 px-2.5 py-1 text-xs text-purple-600 sm:px-3">
                        {repo.language}
                      </span>
                    )}
                  </CardContent>
                  <CardFooter className="flex flex-col gap-2 pt-3 sm:flex-row sm:gap-3">
                    ...
                    >
                      <Link
                        ...
                        className="flex w-full items-center justify-center gap-2 rounded-full border border-purple-600 px-3 py-2 text-xs font-semibold transition-colors hover:bg-purple-600/10 sm:w-auto sm:px-4 sm:text-sm"
                      >
                    ...
                    {repo.homepage && (
                      ...
                      >
                        <Link
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="flex w-full items-center justify-center rounded-full bg-purple-600 px-3 py-2 text-xs font-semibold text-white transition-colors hover:bg-purple-500 sm:w-auto sm:px-4 sm:text-sm"
                        >
      ...
      >
        <div className="mx-auto max-w-2xl text-center">
          ...
          <motion.p
            className="text-muted-foreground mb-10 text-base leading-relaxed sm:mb-12 sm:text-xl"
            initial={{ opacity: 0, y: 24 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.6, delay: 0.2 }}
          ...
          >
            ...
            >
              <Link
                ...
                className="rounded-full bg-purple-600 px-6 py-3 text-base font-semibold text-white transition-colors hover:bg-purple-500 sm:px-8 sm:py-4 sm:text-lg"
              >
